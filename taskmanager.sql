...
--
-- Host: localhost
-- Generation Time: Apr 19, 2023 at 03:43 AM
...
INSERT INTO `zadatak` (`zadatakID`, `naziv`, `korisnik`, `kategorija`, `opis`, `datumKreiranja`, `izvrsen`, `datumZavrsetka`) VALUES
(11, 'Očisti stan', 12, 2, 'Neki tekst', '2023-04-16', 1, '2023-04-18'),
(12, 'Odgovori na mejl', 12, 1, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean neque lectus, malesuada sit amet tincidunt eu, sodales ac urna. Maecenas dictum laoreet eros vel hendrerit. Ut est mi, tempus at magna non, euismod luctus risus.', '2023-04-17', 1, '2023-04-19'),
(17, 'Sredi policu', 12, 3, 'Neki tekst', '2023-04-17', 0, NULL),
(18, 'Organizuj put', 12, 2, 'Neki tekst', '2023-04-17', 0, NULL),
(19, 'Predaj dokumenta', 12, 1, 'Neki tekst', '2023-04-17', 0, NULL),
(20, 'Spremi večeru', 12, 2, 'Neki tekst', '2023-04-17', 0, NULL);
...
--
ALTER TABLE `zadatak`
  MODIFY `zadatakID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
