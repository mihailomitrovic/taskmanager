...
if (isset($_POST["button"])) {
    ...
    $ime = time()."_".$_FILES["custom_button"]["name"];
    $target = "../slike/".$ime;
    
    move_uploaded_file($_FILES["custom_button"]["tmp_name"], $target);
    ...
    <div class="container_wrapper">
        ...
        <form method="post" action="" enctype="multipart/form-data" class="container_unos" id="forma">
            ...
            <div id="slikadiv">
                ...
                <button type="button" name="custom_button" id="custom_button" class="inputslika" value="";>Izaberi sliku</button>
            </div>
