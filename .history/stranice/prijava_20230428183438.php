...
<body>
    <div id="contentreg">
        ...
        <form class="container" method="post" action="" id="forma" enctype="multipart/form-data" novalidate>      
            <h3>Email*</h3>
            <input type="email" name="email" id="email" class="input" placeholder="Email" onchange="saveValue(this);" required>
            ...
            <div id="nepoklapase" <?php if ($greska == 1) {?> style="display:flex, margin-top: 5px" <?php } else { ?> style = "display:none" <?php } ?> >
                <h5 <?php if ($greska == 1) {?> style="color: #eb7178" <?php }?>>Podaci se ne poklapaju</h5>
            </div>
