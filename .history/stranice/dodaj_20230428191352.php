...
<body>
    ...
    <div class="container_wrapper">
        ...
        <form method="post" action="" enctype="multipart/form-data" class="container_unos" id="forma" novalidate>
            ...
            <div id="falinaziv">
                <h5 class="crvena">Unesite naziv</h5>
            </div>
            ...
            <div id="faliopis">
                <h5 class="crvena">Izabrati kategoriju</h5>
            </div>
            ...
            <div id="faliopis">
                <h5 class="crvena">Unesite opis</h5>
            </div>
...
<script>  
    ...
    function predaj() {
        $("#forma").ajaxForm(function() {
            ...
            $("#custom_button").hover("border", "2.5pt solid black");
            resetuj();
        })
    }
    ...
    const slika = document.getElementById('real_file');
  ...
  .addEventListener(
    ...
    (event) => {
        ...
        falikategorija.classList.toggle('error', !kategorija.validity.valid);
