...
<body>
    ...
    <div class="containerwrapper">
        ...
        <form method="post" action="" enctype="multipart/form-data" class="container_izmena" id="formaizmena" class="formaizmena">
            <div id = "levo">
            </div>
...
<script>  
    ...
    function izmeni() {
        $("#forma").ajaxForm(function() {
            ...
            $("#levo").css("background-color", "red").change();
        })
    }
    ...
    function obrisi() {
        $("#forma").ajaxForm(function() {
            ...
            $("#skrivenoizmeni").css("visibility", "visible");
            $("#levo").css("border-color", "#ffffff").change();
        })
    }
</script>
