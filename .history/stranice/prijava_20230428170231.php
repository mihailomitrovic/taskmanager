...
<body>
    <div id="contentreg">
        ...
        <form class="container" method="post" action="" id="forma" enctype="multipart/form-data" novalidate>      
            ...
            <div id="neispravnaadresa">
                <h5 class="crvena">Email adresa nije u ispravnom formatu</h5>
            </div>
...
<script>  
  ...
  .addEventListener(
    ...
    () => {
        email.classList.toggle('error', email.validity.valid);
        faliemail.classList.toggle('uredu', !email.validity.valid);
...
lozinka
  .addEventListener(
    ...
    () => {
        ...
        falilozinka.classList.toggle('uredu', !lozinka.validity.valid);
    }
);
