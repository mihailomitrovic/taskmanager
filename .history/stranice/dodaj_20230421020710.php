...
<body>
    ...
    <div class="container_wrapper">
        <form method="post" action="" enctype="multipart/form-data" class="container_unos">
            ...
            <h4>Slika</h4>
                <label for="slika" id="slikalabel" name="slikalabel" class="inputslika">Unesi sliku</label>
                <input type="file" name="slika" id="slika" accept=".jpg, .jpeg, .png" value="" style="display: none" oninput="izmeniLabelu();">
...
<script>  
    ...
    function izmeniLabelu() {
       $("#slikalabel").text("<?php echo $ime ?>").change;
    }
</script>
