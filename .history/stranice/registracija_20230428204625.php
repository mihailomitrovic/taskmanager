...
<body>
    <div id="contentreg">
        ...
        <form class="container" method="post" action="" autocomplete="off" id="formareg" enctype="multipart/form-data" novalidate>
            <h3>Ime*</h3>
            <input type="email" name="ime" id="ime" class="input" placeholder="Ime" required>
            ...
            <h3>Prezime*</h3>
            <input type="email" name="prezime" id="prezime" class="input" placeholder="Prezime" required>    
