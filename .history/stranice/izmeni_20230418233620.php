        ...
        <form method="post" action="" enctype="multipart/form-data" class="container_izmena">
            ...
            <div id="buttonwrapper">
                <div class="buttoncontainer">
                    <input class="button" name="akcija" value = "izmeni" type="submit">Izmeni zadatak</input>
                </div>
                <div class="buttoncontainer">
                    <input class="button2" name="akcija" value = "obrisi" type="submit">Izbriši zadatak</input>
                </div>
            </div>
            </div>
        </form>
