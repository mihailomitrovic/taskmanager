...
<body>
    <div id="contentreg">
        ...
        <form class="container" method="post" action="" autocomplete="off" id="formareg" enctype="multipart/form-data" novalidate>
            ...
            <h3>Email*</h3>
            <input type="email" name="email" id="email1" class="input" placeholder="Email" required>   
            ...
            <h3>Lozinka*</h3>
            <input type="password" name="lozinka" id="lozinka1" class="input" placeholder="Šifra" required>  
