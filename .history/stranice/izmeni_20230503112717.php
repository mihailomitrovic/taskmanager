...
if (isset($_POST["button2"])) {
    ...
    Zadatak::izmeniBezSlike($zadatak, $naziv, $kategorija, $opis, $izvrsen, $ime, $konekcija);
}
...
<body>
    ...
    <div class="containerwrapper">
        ...
        <form method="post" action="" enctype="multipart/form-data" class="container_izmena" id="formaizmena">
            ...
            <input type="text" value="" id="ostavi" name="ostavi" hidden="hidden">
        </form>
        </div>
    </div>
