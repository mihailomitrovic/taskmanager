...
<body>
    <div id="contentreg">
        ...
        <form class="container" method="post" action="" id="forma" enctype="multipart/form-data" novalidate>      
            ...
            <div id="faliemail">
                <h5 class="crvena">Unesite ispravni email</h5>
            </div>
...
<script>  
  ...
  .addEventListener(
    ...
    (event) => {
        ...
        faliemail.classList.toggle('promeni');
        falilozinka.classList.toggle('promeni');

      if(!email.validity.valid){
        faliemail.classList.toggle('promeni]')
        event.preventDefault();
      } else {
        faliemail.classList.toggle('uredu')
      }
      ...
      if(!lozinka.validity.valid){
        ...
        falilozinka.classList.toggle('uredu')
      }
