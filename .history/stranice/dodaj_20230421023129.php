...
<body>
    ...
    <div class="container_wrapper">
        <form method="post" action="" enctype="multipart/form-data" class="container_unos">
            ...
            <input type="file" name="slika" id="slika" accept=".jpg, .jpeg, .png" value="" style="display: none" onchange="$('#slikalabel span').text('<?php echo $tempime; ?>').change;">
...
<script>  
    ...
    function promeniLabelu() {
        $(".inputslika").change(function() {
            $('#slikalabel span').text("<?php echo $tempime; ?>").change;        
        });
    }
</script>
