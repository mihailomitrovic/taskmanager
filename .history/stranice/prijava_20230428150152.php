...
<body>
    <div id="contentreg">
        ...
        <form class="container" method="post" action="" id="prijavaforma" enctype="multipart/form-data">      
            <h3>Email*</h3>
...
<script>  
    $().ready(function () {
        $("#prijavaforma").validate({
            ...
            messages: {
                email: "Molimo Vas unesite email",
                lozinka: "Molimo Vas unesite lozinku"
            }
        })
    })
</script>
