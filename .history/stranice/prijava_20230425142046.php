...
<body>
    <div id="contentreg">
        ...
        <form class="container" method="post" action="" enctype="multipart/form-data">      
            <h3>Email*</h3>
            <input type="email" name="email" <?php if($errors == 1){echo 'style="border:1px solid red;"';}?> class="input" placeholder="Email" required>        
            <h3>Lozinka*</h3>
            <input type="password" name="lozinka" <?php if($errors == 1){echo 'style="border:1px solid red;"';}?>  class="input" placeholder="Šifra" required>        

            <div class="buttoncontainer">
                <button class="button" name="button" type="submit" onclick="promeniFormu()">Prijavi se</button>
            </div>
