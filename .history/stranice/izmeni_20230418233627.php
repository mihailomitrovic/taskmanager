        ...
        <form method="post" action="" enctype="multipart/form-data" class="container_izmena">
            ...
            <div id="buttonwrapper">
                <div class="buttoncontainer">
                    <button class="button" name="akcija" value = "izmeni" type="submit">Izmeni zadatak</button>
                </div>
                <div class="buttoncontainer">
                    <button class="button2" name="akcija" value = "obrisi" type="submit">Izbriši zadatak</button>
                </div>
            </div>
            </div>
        </form>
