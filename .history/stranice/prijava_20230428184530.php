...
<body>
    <div id="contentreg">
        ...
        <form class="container" method="post" action="" id="forma" enctype="multipart/form-data" novalidate>      
            ...
            <div id="nepoklapase" <?php if ($greska == 1) {?> style="display:flex; margin-top: 5px; margin-bottom: -25px;" <?php } else { ?> style = "display:none" <?php } ?> >
                <h3 style="color: #eb7178">Podaci se ne poklapaju</h3>
            </div>
...
<script>  
    ...
    const emailVrednost = document.getElementById('email').val();
