...
<body>
    <div id="contentreg">
        ...
        <form class="container" method="post" action="" id="forma1" enctype="multipart/form-data" novalidate>      
            <h3>Email*</h3>
            ...
            <h3>Lozinka*</h3>
            <input type="password" name="lozinka" id="lozinka" class="input" placeholder="Lozinka" required>
            ...
            <div id="nepoklapase">
                <h5 style="color: #eb7178">Pogrešno uneti podaci</h5>
            </div>
