...
--
-- Host: localhost
-- Generation Time: May 05, 2023 at 01:05 PM
...
CREATE TABLE `kategorija` (
  ...
  `nazivKategorije` varchar(255) CHARACTER SET utf8mb4 NOT NULL
...
CREATE TABLE `korisnik` (
  ...
  `ime` varchar(255) CHARACTER SET utf8mb4 NOT NULL,
  `prezime` varchar(255) CHARACTER SET utf8mb4 NOT NULL,
  `email` varchar(255) CHARACTER SET utf8mb4 NOT NULL,
  `lozinka` varchar(255) CHARACTER SET utf8mb4 NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `zadatak` (
  ...
  `naziv` varchar(255) CHARACTER SET utf8mb4 NOT NULL,
  `korisnik` int(11) NOT NULL,
  `kategorija` int(11) NOT NULL,
  `opis` varchar(255) CHARACTER SET utf8mb4 NOT NULL,
  `datumKreiranja` date NOT NULL,
  `izvrsen` int(11) NOT NULL DEFAULT 0,
  `datumZavrsetka` date DEFAULT NULL,
  `slika` varchar(255) CHARACTER SET utf8mb4 DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
ALTER TABLE `korisnik`
  MODIFY `korisnikID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=87;

--
-- AUTO_INCREMENT for table `zadatak`
--
ALTER TABLE `zadatak`
  MODIFY `zadatakID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=611;
