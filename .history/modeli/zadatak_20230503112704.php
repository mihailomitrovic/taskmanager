...
class Zadatak {
    ...
    public static function izmeniBezSlike($zadatak, $naziv, $kategorija, $opis, $izvrsen, mysqli $konekcija) {
        $datumZavrsetka = null;
        ...
        if ($izvrsen == "1") {
            ...
            $dodaj->bind_param("sisissi", $naziv, $kategorija, $opis, $izvrsen, $datumZavrsetka, $zadatak);
            $dodaj->execute();
    }
