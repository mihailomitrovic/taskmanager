...
<?php
    if ($podaci->izvrsen == "0") {  
?> 
<div class="detaljilevonad">
    <div class = "detaljilevo">
        <div class="detaljilevosub">
            <div class="detaljilevosub2">
                ...
                <h5 class="datum2">Datum kreiranja: <?=$noviDatumKreiranja?></h5>
            </div>
...
<div class="detaljilevo">
    <div class="detaljilevosub">
        ...
        <h5 class="datum2">Datum završetka: <?=$noviDatumZavrsetka?></h5>
        </div>
...
<div id="buttonwrapperdetalji">
            <button type="submit" class="dugmedetalji" name="button" onclick="ponistiZadatak();">Poništi zadatak</button>
            <form action="izmeni.php">
