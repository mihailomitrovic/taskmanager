...
?>
    ...
    <div class="datadeo1">
        ...
        <?php } else { ?>
            <div class="slikawrapnad">
                <div class="slikawrap1" style = "background-image='url('../slike/<?=$podaci->slika?>')'">
                </div>
                <input type="file" name="real_file" id="real_file" accept=".jpg, .jpeg, .png" value="" hidden="hidden">
                <button type="button" id="custom_button" class="inputslika1">Izmeni sliku</button>
                <button type="button" id="custom_button" class="inputslika2">Obriši sliku</button>
            </div>
        <?php } ?>
