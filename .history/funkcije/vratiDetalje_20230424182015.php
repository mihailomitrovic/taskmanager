...
<div class="detaljilevo">
    ...
    <div id="buttonwrapperdetalji">
        <button type="submit" class="dugmedetalji" name="buttondet" onclick="ponistiZadatak();">Poništi zadatak</button>
        <form action="izmeni.php">
        <button type="submit" class="dugmedetalji" name="button2det" onclick="izmeni();">Izmeni zadatak</button>
        </form>
    </div>
</div>
