...
<h4><span class="krataktekst">Nemaš nijedan zadatak — </span></h4><a href="../stranice/dodaj.php" id="nemazadatakalink"><h4 style="font-weight: bold">unesi novi<h4></a><h4 id="uzvicnik">!</h4>
<div>
<?php
    }
?>