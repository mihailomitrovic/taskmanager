    ...
    <div class="datadeo1">
        ...
        <?php } else { ?>
            <div id = "slikawrapnad" class="slikawrapnad">
                ...
                <button type="button" id="custom_button1" class="inputslika1"><span class="puntekst" onclick="izmeni();">Izmeni sliku</span><span class="krataktekst">Izmeni</span></button>
                <button type="button" id="custom_button2" class="inputslika2" onclick="resetujFormu();"><span class="puntekst">Obriši sliku</span><span class="krataktekst">Obriši</span></button>
            </div>
        <?php } ?>
        ...
        <div id="buttonwrapperizmena">
            <div class="buttoncontainerizmena">
                <button type="submit" class="buttonizmena" name="button" onchange="izmeniZadatak();"><span class="puntekst">Izmeni zadatak</span><span class="krataktekst">Izmeni</span></button>
            </div>
            <div class="buttoncontainerizmena">
        ...
        <input id="uradi" value="" type="hidden">
...
<script>
    ...
    function izmeni() {
        $("#uradi").val("NESTO").change();
        console.log($("#uradi").val());
    }

    function izmeniZadatak() {
        let provera = "<?=$podaci->slika?>";
        let uradi = $("#uradi").val();
