    ...
    <div class="datadeo1">
        ...
        <div id="buttonwrapper">
            <div class="buttoncontainer">
                <button type="submit" class="buttonizmena" name="button" onclick="izmeniZadatak();">Izmeni zadatak</button>
            </div>
            <div class="buttoncontainer">
                <button type="submit" class="button2izmena" name="button2" onclick="obrisiZadatak();">Obriši zadatak</button>
            </div>
        </div>
    </div>
