...
?>
    ...
    <div class="datadeo1">
        ...
        <div id="buttonwrapperizmena">
            ...
            <div class="buttoncontaineizmena">
                <button type="submit" class="button2izmena" name="button2" onclick="obrisiZadatak();"><span class="puntekst">Obriši zadatak</span><span class="krataktekst">Obriši</span></button>
            </div>
        </div>
    </div>
