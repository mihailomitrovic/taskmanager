...
<div class = "detaljilevo">
    ...
    <div id="buttonwrapperdetalji">
        ...
        <a href="../stranice/izmeni.php" class="dugmedetalji"><button type="button" name="button2">Izmeni zadatak</button></a>
    </div>
</div>
...
<div class="detaljilevo">
    ...
    <div id="buttonwrapperdetalji">
        ...
        <a href="../stranice/izmeni.php?data=<?=$podaci->zadatakID?>" class="dugmedetalji"><button type="button" name="button2">Izmeni zadatak</button></a>
    </div>
</div>
...
<script>
    ...
    function sesija() {
        session_start();
        $_SESSION["zadatak"]=<?=$podaci->zadatakID?>;
    }
 </script>