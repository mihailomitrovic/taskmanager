...
<div class = "detaljilevo">
    ...
    <div id="buttonwrapperdetalji">
        <button type="submit" class="dugmedetalji" name="button" onclick="filtrirajIzmena();">Izvrši zadatak</button>
...
<div class="detaljilevo">
    ...
    <div id="buttonwrapperdetalji">
        <button type="submit" class="dugmedetalji" name="button" onclick="izvrsiZadatak(); filtrirajIzmena();">Poništi zadatak</button>
        <form action="izmeni.php">
        <button type="submit" class="dugmedetalji" name="button2" onclick="izmeni();">Izmeni zadatak</button>
        </form>
    </div>
