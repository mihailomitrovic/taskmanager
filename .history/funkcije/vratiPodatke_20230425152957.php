    ...
    <div class="datadeo1">
        ...
        <?php } else { ?>
            <div id = "slikawrapnad" class="slikawrapnad">
                ...
                <button type="button" id="custom_button" class="inputslika2" onclick="resetujFormu();"><span class="puntekst">Obriši sliku</span><span class="krataktekst">Obriši</span></button>
            </div>
        <?php } ?>
        ...
        <div id="buttonwrapper">
            <div class="buttoncontainer">
                <button type="submit" class="button" name="button" onclick="izmeniZadatak();"><span class="puntekst">Izmeni zadatak</span><span class="krataktekst">Izmeni</span></button>
            </div>
            <div class="buttoncontainer">
                <button type="submit" class="button2" name="button2" onclick="obrisiZadatak();"><span class="puntekst">Obriši zadatak</span><span class="krataktekst">Obriši</span></button>
            </div>
        </div>
    </div>
