...
<div class = "detaljilevo">
    ...
    <div id="buttonwrapperdetalji">
        ...
        <button class="dugmedetalji" type="button" name="button2" onclick="sesija();">Izmeni zadatak</button>
    </div>
</div>
...
<div class="detaljilevo">
    ...
    <div id="buttonwrapperdetalji">
        ...
        <button class="dugmedetalji" type="button" name="button2" onclick="izmeni();">Izmeni zadatak</button>
    </div>
</div>
