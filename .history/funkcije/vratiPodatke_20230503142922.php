...
<script>
    ...
    function obrisiZadatak() {
        $("#formaizmena").ajaxForm(function() {             $("#prikaziizmeni").css("display", "flex");             $("#prikaziizmenitekst").text("Zadatak je uspešno obrisan");             $("#prikaziobrisi").css("display", "flex");             $("#skriveno").css("display", "none");         },complete: function() {             popuniZadatke();          })
    }
